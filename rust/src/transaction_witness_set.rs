...
use cardano_serialization_lib::{
    plutus::{
        PlutusData as RPlutusData, PlutusDataKind, Redeemer as RRedeemer,
        RedeemerTag as RRedeemerTag, RedeemerTagKind, Redeemers as RRedeemers,
    },
...
pub unsafe extern "C" fn cardano_transaction_witness_set_clone(
    ...
    result: &mut TransactionWitnessSet,
    error: &mut CError,
) -> bool {
