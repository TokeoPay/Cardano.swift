...
use cardano_serialization_lib::{
    crypto::PoolMetadataHash as RPoolMetadataHash,
...
pub unsafe extern "C" fn cardano_dns_record_aor_aaaa_clone(
    dns_record_aor_aaaa: DNSRecordAorAAAA,
    result: &mut DNSRecordAorAAAA,
    error: &mut CError,
) -> bool {
...
pub unsafe extern "C" fn cardano_dns_record_srv_clone(
    dns_record_srv: DNSRecordSRV,
    result: &mut DNSRecordSRV,
    error: &mut CError,
) -> bool {
