...
let ccardano: Target = useLocalBinary ?
    ...
    .binaryTarget(
        name: "CCardano",
        url: "https://pub-5314ba2a19a94f41912a726140440b24.r2.dev/CCardano.binaries.7689916.zip",
        checksum: "7689916f8a2991f6ae131beae594801f4faf2bf60b163411c110283316465dac")
