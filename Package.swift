...
let ccardano: Target = useLocalBinary ?
    ...
    .binaryTarget(
        name: "CCardano",
        url: "https://pub-5314ba2a19a94f41912a726140440b24.r2.dev/CCardano.binaries.c52b23c.zip",
        checksum: "c52b23cf042a8752c1989d98f9e9e3fef17fdd28a574d1bf364c816c68571a57")
