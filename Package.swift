...
let ccardano: Target = useLocalBinary ?
    ...
    .binaryTarget(
        name: "CCardano",
        url: "https://pub-5314ba2a19a94f41912a726140440b24.r2.dev/CCardano.binaries.170a0fda.zip",
        checksum: "170a0fda7596ced94533f72c97ee8a7837b066db152ea430308308c573b3f2ca")
